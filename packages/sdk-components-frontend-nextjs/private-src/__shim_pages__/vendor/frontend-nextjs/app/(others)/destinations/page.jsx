...
export const metadata = {
  title: "Popular Destinations | Flymefy - Your Ultimate Travel Companion",
  description: "Discover amazing destinations around the world with Flymefy. Find the best hotels, tours, activities and travel deals.",
  keywords: "travel destinations, popular destinations, travel guides, vacation spots",
};
