...
export const metadata = {
  ...
  description: "Get in touch with Flymefy. Contact our travel experts for personalized assistance with your bookings, travel plans and any questions.",
  keywords: "contact flymefy, customer support, travel help, contact travel agency",
};
        ...
        <div className="row justify-end">
          <div className="col-xl-5 col-lg-7">
            <div className="map-form px-40 pt-40 pb-50 lg:px-30 lg:py-30 md:px-24 md:py-24 bg-white rounded-4 shadow-4">
              <div className="text-22 fw-500">Send us a message</div>
              <ContactForm />
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row x-gap-80 y-gap-20 justify-between">
            <div className="col-12">
              <div className="text-30 sm:text-24 fw-600">Contact Flymefy</div>
            </div>
            {/* End .col */}
            ...
            <div className="col-auto">
              <div className="sectionTitle -md">
                ...
                <p className=" sectionTitle__text mt-5 sm:mt-0">
                  Experience exceptional service and unmatched value in travel
                </p>
              </div>
            </div>
          </div>
